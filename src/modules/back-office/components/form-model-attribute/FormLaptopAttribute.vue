    ...
    <el-form ref="ruleFormRef" :model="formAttribute" :rules="rules" label-position="top">
      ...
      <div class="flex justify-between">
        <el-form-item label="Series Laptop" prop="laptopSeries">
          <el-select v-model="formAttribute.laptopSeries" filterable placeholder="Chọn series laptop" remote
                     reserve-keyword>
        ...
        <el-form-item label="Series CPU" prop="cpuSeries">
          <el-select v-model="formAttribute.cpuSeries" filterable placeholder="Chọn series laptop" remote
                     reserve-keyword>
      ...
      <div class="flex w-full">
        <el-form-item class="w-full" label="Kích thước màn hình" prop="monitorSize">
          <el-select
              ...
              clearable
              filterable
              placeholder="Chọn series laptop"
              remote
              reserve-keyword
          >
            <el-option v-for="item in dataList.getMonitorSize" :key="item.value" :label="item.name"
                       :value="item.value"/>
          </el-select>
        </el-form-item>
      </div>
      <div class="flex w-full flex-col">
        ...
        <el-form-item class="w-full" label="Hệ điều hành" prop="laptopOperatingSystem">
          <el-input v-model="formAttribute.laptopOperatingSystem"
                    placeholder="VD: Windows 11 Home Windows 11"></el-input>
        </el-form-item>
