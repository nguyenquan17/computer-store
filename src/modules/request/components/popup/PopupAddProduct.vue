          ...
          <div class="left flex-[0.6]">
            ...
            <div class="flex justify-between">
              <el-form-item class="flex-1" label="Danh mục sản phẩm">
                <el-select v-model="form.categoryId" :teleported="false" class="w-full" clearable
            ...
            <div class="flex justify-between">
              <el-form-item class="flex-1" label="Mô tả ngắn sản phẩm">
                <el-input v-model="form.shortDescription" :rows="4" placeholder="Nhập mô tả sản phẩm"
...
import FormLaptopAttribute from '@/modules/request/components/form-model-attribute/FormLaptopAttribute.vue'
