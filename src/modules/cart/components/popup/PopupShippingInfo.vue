<template>
  ...
  >
    ...
    <div>
      <el-form ref="ruleFormRef" :model="formShipping" :rules="rules" label-position="top">
        ...
        <el-form-item label="Số điện thoại" prop="consigneePhoneNumber">
          <el-input
            v-model="formShipping.consigneePhoneNumber"
            @keypress="useOnlyNumber($event, formShipping.consigneePhoneNumber)"
          />
        </el-form-item>
        ...
        <el-form-item class="wrap-btn">
          ...
          <base-button type="primary" @click="submitForm(ruleFormRef)"> Xác nhận </base-button>
        </el-form-item>
      </el-form>
    </div>
  </base-popup>
