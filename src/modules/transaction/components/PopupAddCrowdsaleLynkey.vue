<template>
  <base-popup name="popup-add-crowdsale-lynkey" class="popup-member" width="480px" :close="handleClose" :open="handleOpen">
        ...
        <div class="be-flex jc-space-between">
          <el-form-item :label="$t('label.paid-amount')" class="be-flex-item" :class="invalidAmount ? 'is-error' : null" prop="amount">
            <el-input
              ...
              :placeholder="$t('placeholder.amount-crowdsale-LYNK')"
...
<script lang="ts">
  ...
  export default class PopupAddCrowdsaleLynkey extends Mixins(PopupMixin) {
